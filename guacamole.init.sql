...
CREATE USER 'guacamole-db' IDENTIFIED BY 'guacamole-db';
GRANT ALL PRIVILEGES ON guacamole_db.* TO 'guacamole-db'@'localhost' IDENTIFIED BY 'guacamole-db' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON guacamole_db.* TO 'guacamole-db'@'%' IDENTIFIED BY 'guacamole-db' WITH GRANT OPTION;
FLUSH PRIVILEGES;
USE `guacamole_db`;
